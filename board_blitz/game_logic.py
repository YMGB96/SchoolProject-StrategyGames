...
import menu_logic as menu_logic
...
active_difficulty = menu_logic.menu_logic.active_difficulty
active_game = menu_logic.menu_logic.active_game
active_user = menu_logic.menu_logic.active_user
...
def get_valid_moves(board, game, *args, **kwargs):
...
def switch_turn(board):
    ...
    ai.next_move(board, active_difficulty) #placeholder for communication with AI
